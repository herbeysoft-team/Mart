...
export default function OrderCompleteModel({
  openOrderCompleteModel,
  gotoHome,
}) {
  return (
    <Modal
      animationType="slide"
      transparent={true}
      visible={openOrderCompleteModel}
    >
      <View
        style={{
          flex: 1,
      ...
      >
        ...
        >
          ...
          >
            {
              "Your order has successfully being placed \n the vendor with contact you shortly "
            }
          </Text>
